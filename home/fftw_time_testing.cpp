...
int main(int argc, char ** argv)
{
    ...
    for (int ss = 1; ss < 129; ss*=2)
    {
        ...
        fftw_plan planBack;
        // std::cout << "Построение плана...." << std::endl;
        ...
        // std::cout << "План построен" << std::endl;
        ...
        std::cout << N << ' ' << std::chrono::duration<double>(endFunc - startFunc).count() * 1000000 / COUNT_TEST << std::endl;
    }
